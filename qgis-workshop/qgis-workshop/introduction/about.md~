...
*QGIS* is an open source, freely downloadable and distributable desktop GIS package. It has an active developer and user community, and is widely used in the humanitarian world. It's robust, well-supported (including by many commercial organisations), and integrates extremely well with other open source tools such as PostGreSQL/PostGIS and GeoServer. It uses as components other open source libraries such as OGR and GDAL, enabling it for example to handle all standard GIS formats such as shapefile, KML and MapInfo TAB file, as well as some non-standard ones.
